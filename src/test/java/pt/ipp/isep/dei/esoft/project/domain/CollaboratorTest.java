...
class CollaboratorTest {
    ...
    void ensureCollaboratorIsCreatedSuccessfully() {
        ...
        Collaborator collaborator = new Collaborator("name", "dd-MM-yyyy", "dd-MM-yyyy", "somewhere", 123456789, "johnlemon@beetle.thing", "CC", 123456789, hrm);
    }
    ...
    void ensureCollaboratorNameIsNotNull() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new Collaborator(null, "dd-MM-yyyy", "dd-MM-yyyy", "somewhere", 123456789, "johnlemon@beetle.thing", "CC", 123456789, hrm));
    }
    ...
    void testEqualsDifferentObjects() {
        HRM hrm = new HRM("john.doe@this.company.com");
        Collaborator collaborator = new Collaborator("name", "dd-MM-yyyy", "dd-MM-yyyy", "somewhere", 123456789, "johnlemon@beetle.thing", "CC", 123456789, hrm);
        Collaborator collaborator1 = new Collaborator("nemlei", "dd-MM-yyyy", "dd-MM-yyyy", "somewhere", 123456789, "johnlemon@beetle.thing", "CC", 123456799, hrm);
